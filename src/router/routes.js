...
const Progress = resolve => { require.ensure(['../components/Progress.vue'], ()=>{ resolve(require('../components/Progress.vue')); }); };
const CohesionExplorer = resolve => { require.ensure(['../components/CohesionExplorer.vue'], ()=>{ resolve(require('../components/CohesionExplorer.vue')); }); };
const DetailView = resolve => { require.ensure(['../views/DetailView.vue'], ()=>{ resolve(require('../views/DetailView.vue')); }); };
const SearchView = resolve => { require.ensure(['../views/SearchView.vue'], ()=>{ resolve(require('../views/SearchView.vue')); }); };
const RefactorView = resolve => { require.ensure(['../views/RefactorView.vue'], ()=>{ resolve(require('../views/RefactorView.vue')); }); };
const MergeRefactorView = resolve => { require.ensure(['../views/MergeRefactorView.vue'], ()=>{ resolve(require('../views/MergeRefactorView.vue')); }); };
const SplitRefactorView = resolve => { require.ensure(['../views/SplitRefactorView.vue'], ()=>{ resolve(require('../views/SplitRefactorView.vue')); }); };
const MoveMethodsRefactorView = resolve => { require.ensure(['../views/MoveMethodsRefactorView.vue'], ()=>{ resolve(require('../views/MoveMethodsRefactorView.vue')); }); };
...
export const routes = [
    ...
    { path : '/coex', component: CohesionExplorer },
    { path : '/search', name: 'search',component: SearchView },
    { path : '/detail', name: 'detail', component: DetailView },
    { path : '/guirefactor', name: 'refactor', component: RefactorView },
    { path : '/guirefactor/merge', name: 'merge-refactor', component: MergeRefactorView },
    { path : '/guirefactor/split', name: 'split-refactor', component: SplitRefactorView },
    { path : '/guirefactor/move', name: 'move-refactor', component: MoveMethodsRefactorView },
    { path : '/components/progress', name: 'progress', component: Progress },
