                        ...
                        <div class="header-left" :class="{'open': isSearch, '': !isSearch }">
                            ...
                            <div class="form-inline">
                                <form class="search-form" @submit.prevent="handleSearch">
                                    <input id="quicksearch" class="form-control mr-sm-2" type="text" placeholder="Search ..." aria-label="Search">
                                    <button
                                        class="search-close"
                                        type="submit"
...
<script>
    ...
    methods: {
        ...
        handleSearch(){
            var queryName = $(('#quicksearch')).val();
            this.$router.push({ path: '/search', query: { name: queryName } })
        },
        handleClick(e){
